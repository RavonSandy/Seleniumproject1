...
public class parallelTest {
	...
	public void search_Testcase() throws InterruptedException {
		...
		driver.findElement(By.id("lastName")).sendKeys("teamss");
		...
		driver.findElement(By.id("systemUser_password")).sendKeys("iplmatch2000");
		driver.findElement(By.id("systemUser_confirmPassword"))
				.sendKeys("iplmatch2000");
		Thread.sleep(200);
		driver.findElement(By.xpath("//input[@id='btnSave']")).click();
		// ADDSearch
		driver.findElement(By.id("menu_admin_viewAdminModule")).click();
